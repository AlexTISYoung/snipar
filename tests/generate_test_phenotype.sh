...
print(king_chr12);
'
plink/plink --file outputs/tmp/t__t --make-bed --out test_data/full_sample1
plink/plink --bfile test_data/full_sample1 --remove outputs/tmp/t__t_remove.txt --make-bed --out test_data/sample1

python example/simulate_trait_quad.py test_data/full_sample1.bed outputs/tmp/t__t_fams.ped 0.8 test_data/h2_quad_0.8 --no_sib --dncor 0.5