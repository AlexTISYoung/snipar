...
for i in {1..16}
do
pgs.py $gpardir/pgs/results/gparsum_$i --pgs $gpardir/pgs/EA4_hm3.pgs.txt --phenofile $gpardir/processed_traits_noadj.txt --covar $gpardir/covariates.fam  --gen_models 1-3 --phen_index $i --scale_pgs --scale_phen --gparsum --bpg --sparse_thres 0.025 --ibdrel_path $gpardir/king
done
