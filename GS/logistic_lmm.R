...
pgs_files = paste(pgsdir,c('EA4_hm3.pgs.txt','depression/PGC_UKB_depression.pgs.txt',
                'height/height_UKB.pgs.txt','bmi/BMI_UKB.pgs.txt',
                'ever_smoke/GSCAN_SmkInit_2022_GWAS_SUMMARY_STATS_EUR.pgs.txt'),sep='/')
